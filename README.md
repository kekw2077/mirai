...
> **Desktop-версия — EVS (Enhanced Voice System, только Windows)** — вынесена в
> отдельный самостоятельный проект:
> **[github.com/kekw2077/enhanced-voice-system](https://github.com/kekw2077/enhanced-voice-system)**.
> Этот репозиторий — мобильная/кросс-платформенная линия Mirai.
...
Подробности архитектуры и окружения сборки — в [test1/CLAUDE.md](test1/CLAUDE.md).
